...
public class Transport_Carrier extends Fragment {

    List<Transport_Carrier_model> transportCarrierModelList;
    Transport_Carrier_Adapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_transport__carrier, container, false);
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    if(Success.equals("true")){
                        ...
                        transportCarrierModelList = new ArrayList<>();

                        RecyclerView recyclerView = root.findViewById(R.id.transportt_services_recycle);


                        for (int i = 0; i < 1; i++) {

                            Transport_Carrier_model viewmodel = new Transport_Carrier_model();
                            ...
                            transportCarrierModelList.add(viewmodel);

                        }

                        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));

                        adapter =  new Transport_Carrier_Adapter(getContext(),transportCarrierModelList);
