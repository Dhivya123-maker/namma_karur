...
public class Fragment_Transport extends Fragment {
    ...
    RelativeLayout web;
    String id = null;
    String education_category_id = null;
    String logo = null;
    String Banner = null;
    ...
    transport_Comments_Adapter adapter;

    int images[]={R.drawable.banner,
            R.drawable.banner,
            R.drawable.banner,
            R.drawable.banner};
    String transport_category_id,data,data1,verified,description,location,website,email,phone,whatsapp,facebook,instagram,twitter,youtube,view_count = null;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
      ...
      View root = inflater.inflate(R.layout.fragment__transport, container, false);
        ...
        sliderView = root.findViewById(R.id.slider_sr2);
        ...
        titlee = root.findViewById(R.id.ac_title2);
        addres = root.findViewById(R.id.address_txt2);
        rate = root.findViewById(R.id.rate2);
        verify = root.findViewById(R.id.verifyy_txt2);
        view_ct = root.findViewById(R.id.view_count2);
        desc = root.findViewById(R.id.description2);
        open_tm = root.findViewById(R.id.open_time2);
        close_tm = root.findViewById(R.id.close_time2);
        phone_num = root.findViewById(R.id.phone_num2);


        ac_image = root.findViewById(R.id.shop_home_logo2);
        loc = root.findViewById(R.id.loc_image2);
        web = root.findViewById(R.id.we_img2);
        mail = root.findViewById(R.id.mail_img2);
        whatsp = root.findViewById(R.id.whatsapp2);
        fb = root.findViewById(R.id.facebook2);
        inst = root.findViewById(R.id.insta2);
        twitt = root.findViewById(R.id.twitter2);
        u_tube = root.findViewById(R.id.u_tube2);
        ...
        reviews = root.findViewById(R.id.reviews_lnrr2);
        phone_call = root.findViewById(R.id.phone_call2);
...
//                String mobileNumber = "7397093106";
        ...
        String JSON_URL = "http://nk.inevitabletech.email/public/api/get-transport-details?transport_id=2";
...
//                Toast.makeText(getContext(), response.toString(), Toast.LENGTH_SHORT).show();
                ...
                try {
                    ...
                    transport_category_id = jsonObject.getString("transport_category_id");
...
//
                    Log.i("id",id);
                    Log.i("shop",transport_category_id);
                    Log.i("ban",Banner);
                    Log.i("l",logo);
                    Log.i("t",title);
                    Log.i("a",address);
...
//
                        ...
                        transportCommentsModelList = new ArrayList<>();

                        RecyclerView recyclerView = root.findViewById(R.id.reviews_recycle_post2);


                        for (int i = 0; i < 4; i++) {

                            Transport_Comments_Model viewmodel = new   Transport_Comments_Model();
                            ...
                            transportCommentsModelList.add(viewmodel);

                        }

                        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));

                        adapter =  new transport_Comments_Adapter(getContext(),transportCommentsModelList);
