...
import com.e.login.EducationClass.Education_ServicesFragmentAdapter;
import com.e.login.EducationClass.Education_Services_Model;
import com.e.login.EducationClass.Education_carrier;
...
public class Transport_services_fragment extends Fragment implements Transport_ServicesFragmentAdapter.OnItemClickListener{

    List<Transport_Services_Model> transportServicesModelList;
    Transport_ServicesFragmentAdapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       View root = inflater.inflate(R.layout.fragment_transport_services_fragment, container, false);
        ...
        String JSON_URL = "http://nk.inevitabletech.email/public/api/get-transport-list-detail?transport_id=1";
...
//
                       ...
                       JSONObject jsonObject = response.getJSONObject("data");
                        ...
                        trans_id= jsonObject.getString("transport_id");
                        ...
                        transportServicesModelList = new ArrayList<>();

                        RecyclerView recyclerView = root.findViewById(R.id.transport_services_recycle);


                        for (int i = 0; i < response.length(); i++) {

                            Transport_Services_Model viewmodel = new Transport_Services_Model ();
                            ...
                            transportServicesModelList.add(viewmodel);

                        }

                        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));

                        adapter =  new Transport_ServicesFragmentAdapter(getContext(),transportServicesModelList);
                        recyclerView.setAdapter(adapter);
                        adapter.setOnItemClickListener((Transport_ServicesFragmentAdapter.OnItemClickListener) getActivity());
...
//        }
    ...
    public void onItemClick(int position) {
        Intent intent = new Intent(getContext(), Transport_Carrier.class);
