...
import com.e.login.EducationClass.Education_One_Activity;
...
public class Transport_One_Activity extends AppCompatActivity implements Transport_one_Adapter.OnItemClickListener {

    List<Transport_OneModel> transportOneModelList;
    Transport_one_Adapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_transport_one);
        ...
        String JSON_URL = "http://nk.inevitabletech.email/public/api/get-transport-catalog-list?category_id=1";
...
//                Toast.makeText(Transport_One_Activity.this, response.toString(), Toast.LENGTH_SHORT).show();
...
//                        Log.i("123",msg);
//                        Toast.makeText(Transport_One_Activity.this, msg, Toast.LENGTH_SHORT).show();


                        sliderView = findViewById(R.id.slider_trans);
                        ...
                        transportOneModelList = new ArrayList<>();

                        RecyclerView recyclerView =findViewById(R.id.trans_screen_fragment);


                        for (int i = 0; i < response.length(); i++) {

                            Transport_OneModel viewmodel = new Transport_OneModel();
                            ...
                            transportOneModelList.add(viewmodel);

                        }

                        recyclerView.setLayoutManager(new LinearLayoutManager(Transport_One_Activity.this));

                        adapter =  new Transport_one_Adapter(Transport_One_Activity.this,transportOneModelList);
                        recyclerView.setAdapter(adapter);
                        adapter.setOnItemClickListener(Transport_One_Activity.this);
...
//        }
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(Transport_One_Activity.this);
    ...
    public void onItemClick(int position) {
        Intent intent = new Intent(Transport_One_Activity.this,TransportFragment.class);
