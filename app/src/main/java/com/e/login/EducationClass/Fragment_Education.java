...
public class Fragment_Education extends Fragment  {
    ...
    Education_Comments_Adapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root =  inflater.inflate(R.layout.fragment__education, container, false);
        ...
        sliderView = root.findViewById(R.id.slider_sr5);
        ...
        titlee = root.findViewById(R.id.ac_title5);
        addres = root.findViewById(R.id.address_txt5);
        rate = root.findViewById(R.id.rate5);
        verify = root.findViewById(R.id.verifyy_txt5);
        view_ct = root.findViewById(R.id.view_count5);
        desc = root.findViewById(R.id.description5);
        open_tm = root.findViewById(R.id.open_time5);
        close_tm = root.findViewById(R.id.close_time5);
        phone_num = root.findViewById(R.id.phone_num5);


        ac_image = root.findViewById(R.id.shop_home_logo5);
        loc = root.findViewById(R.id.loc_image5);
        web = root.findViewById(R.id.we_img5);
        mail = root.findViewById(R.id.mail_img5);
        whatsp = root.findViewById(R.id.whatsapp5);
        fb = root.findViewById(R.id.facebook5);
        inst = root.findViewById(R.id.insta5);
        twitt = root.findViewById(R.id.twitter5);
        u_tube = root.findViewById(R.id.u_tube5);
        ...
        reviews = root.findViewById(R.id.reviews_lnrr5);
        phone_call = root.findViewById(R.id.phone_call5);
...
//                String mobileNumber = "7397093106";
        ...
        String JSON_URL = "http://nk.inevitabletech.email/public/api/get-education-catalog-details?education_id=1";
...
//                Toast.makeText(getContext(), response.toString(), Toast.LENGTH_SHORT).show();
                ...
                try {
                    ...
                    education_category_id = jsonObject.getString("education_category_id");
...
//
                    Log.i("id",id);
                    Log.i("shop",education_category_id);
                    Log.i("ban",Banner);
                    Log.i("l",logo);
                    Log.i("t",title);
                    Log.i("a",address);
...
//
                        ...
                        educationCommentsModelList = new ArrayList<>();

                        RecyclerView recyclerView = root.findViewById(R.id.reviews_recycle_post5);


                        for (int i = 0; i < response.length(); i++) {

                            Education_Comments_Model viewmodel = new  Education_Comments_Model();
                            ...
                            educationCommentsModelList.add(viewmodel);

                        }

                        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));

                        adapter =  new Education_Comments_Adapter(getContext(),educationCommentsModelList);
