...
import com.e.login.CarrierClass.Shop_Carrier_Adapter;
...
public class Education_carrier extends Fragment {

    List<education_Carrier_model> educationCarrierModelList;
    education_Carrier_Adapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       View root = inflater.inflate(R.layout.fragment_education_carrier, container, false);
       ...
       data1 = intent.getStringExtra("id");
        ...
        String JSON_URL = "http://nk.inevitabletech.email/public/api/get-education-course-detail?course_id=1";
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    if(Success.equals("true")){
                        ...
                        educationCarrierModelList = new ArrayList<>();

                        RecyclerView recyclerView = root.findViewById(R.id.educationn_services_recycle);


                        for (int i = 0; i < 1; i++) {

                            education_Carrier_model viewmodel = new education_Carrier_model();
                            ...
                            educationCarrierModelList.add(viewmodel);

                        }

                        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));

                        adapter =  new education_Carrier_Adapter(getContext(),educationCarrierModelList);
