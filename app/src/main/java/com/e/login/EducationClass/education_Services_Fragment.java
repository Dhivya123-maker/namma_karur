...
public class education_Services_Fragment extends Fragment implements  Education_ServicesFragmentAdapter.OnItemClickListener  {
    List<Education_Services_Model> educationServicesModelList;
    Education_ServicesFragmentAdapter adapter;
    String data,data1,id,image,course_title,desc,rate;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root =  inflater.inflate(R.layout.fragment_education__services_, container, false);
        ...
        String JSON_URL = "http://nk.inevitabletech.email/public/api/get-education-courses-list?education_id=1";
...
//                        Toast.makeText(getActivity(), msg, Toast.LENGTH_SHORT).show();
                        ...
                        Log.i("johoi",course_title);
                        Log.i("hiuhiu",image);


                        educationServicesModelList = new ArrayList<>();

                        RecyclerView recyclerView = root.findViewById(R.id.education_services_recycle);


                        for (int i = 0; i < response.length(); i++) {

                            Education_Services_Model viewmodel = new Education_Services_Model();
                            ...
                            educationServicesModelList.add(viewmodel);

                        }

                        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));

                        adapter =  new Education_ServicesFragmentAdapter(getContext(),educationServicesModelList);
                        recyclerView.setAdapter(adapter);
                        adapter.setOnItemClickListener((Education_ServicesFragmentAdapter.OnItemClickListener) getActivity());
...
//        }
    ...
    public void onItemClick(int position) {
        Intent intent = new Intent(getContext(), Education_carrier.class);
