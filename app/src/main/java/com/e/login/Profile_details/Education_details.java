...
public class Education_details extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      initMainActivityControls();
                ...
                AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(Education_details.this);
                ...
                saveUserDataButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        SimpleAdapter simpleAdapter = new SimpleAdapter(Education_details.this,itemDataList,android.R.layout.simple_list_item_2,
    ...
    private void initPopupViewControls()
    {
        ...
        LayoutInflater layoutInflater = LayoutInflater.from(Education_details.this);
