...
public class Service_One_activity extends AppCompatActivity implements ServiceAdapter.OnItemClickListener {


    List<Service_OneModel> serviceOneModelList;
    Service_one_Adapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String JSON_URL = "http://nk.inevitabletech.email/public/api/get-service-catalog-list?service_category_id=1";
...
//                Toast.makeText(Service_One_activity.this, response.toString(), Toast.LENGTH_SHORT).show();
...
//                        Log.i("123",msg);
//                        Toast.makeText(Service_One_activity.this, msg, Toast.LENGTH_SHORT).show();
//

                        sliderView = findViewById(R.id.slider_service);
                        ...
                        serviceOneModelList = new ArrayList<>();

                        RecyclerView recyclerView =findViewById(R.id.service1_screen_fragment);


                        for (int i = 0; i < 3; i++) {

                            Service_OneModel viewmodel = new Service_OneModel();
                            ...
                            serviceOneModelList.add(viewmodel);

                        }

                        recyclerView.setLayoutManager(new LinearLayoutManager(Service_One_activity.this));

                        adapter =  new Service_one_Adapter(Service_One_activity.this,serviceOneModelList);
                        recyclerView.setAdapter(adapter);
                        adapter.setOnItemClickListener(Service_One_activity.this);
...
//        }
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(Service_One_activity.this);
    ...
    public void onItemClick(int position) {
        ...
        Intent intent = new Intent(Service_One_activity.this,Service_Fragment.class);
