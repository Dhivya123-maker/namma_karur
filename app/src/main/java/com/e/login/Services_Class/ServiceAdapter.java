...
public class ServiceAdapter extends RecyclerView.Adapter<ServiceAdapter.ViewHolder> {
    ...
    public ServiceAdapter(Context context, List<ServicesModel> servicesModelList) {
    ...
    public ServiceAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.recycler_fifty_five,parent,false);
...
//         holder.textView.setText(animal);
        ...
        holder.textView.setText(servicesModelList.get(position).getText());
       holder.textView1.setText(servicesModelList.get(position).getText_one());
...
//                .into(holder.imageView);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(View itemView) {
            ...
            img1 = itemView.findViewById(R.id.eye_icon1);
