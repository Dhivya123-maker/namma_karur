...
public class Service_Fragment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewPager = findViewById(R.id.viewpager_services);

        // setting up the adapter
        viewPagerAdapter = new ViewPagerAdapter(getSupportFragmentManager());

        // add the fragments
        viewPagerAdapter.add(new Fragment_Service(), "Home");
        viewPagerAdapter.add(new Fragment_services_services(), "Services");
        ...
        tabLayout = findViewById(R.id.tab_layoutt);
