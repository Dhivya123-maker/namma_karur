...
public class Services_Activity extends AppCompatActivity implements ServiceAdapter.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String JSON_URL = "http://nk.inevitabletech.email/public/api/get-service-category-list";
...
//                Toast.makeText(Services_Activity.this, response.toString(), Toast.LENGTH_SHORT).show();
...
//                    Toast.makeText(Services_Activity.this, data.toString(), Toast.LENGTH_SHORT).show();
//
...
//                        Log.i("123",msg);
//                        Toast.makeText(Services_Activity.this, msg, Toast.LENGTH_SHORT).show();
//


                        servicesModelList = new ArrayList<>();

                        RecyclerView recyclerView =findViewById(R.id.services_screen);


                        for (int i = 0; i < 4; i++) {

                            ServicesModel viewmodel = new ServicesModel();
                            ...
                            servicesModelList.add(viewmodel);

                        }

                        recyclerView.setLayoutManager(new LinearLayoutManager(Services_Activity.this));

                        adapter =  new ServiceAdapter(Services_Activity.this,servicesModelList);
                        recyclerView.setAdapter(adapter);
                        adapter.setOnItemClickListener(Services_Activity.this);
...
//        }
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(Services_Activity.this);
    ...
    public void onItemClick(int position) {
        ...
        Intent intent = new Intent(Services_Activity.this,Service_One_activity.class);
        intent.putExtra("id",data1);
        intent.putExtra("token",data);
        intent.putExtra("list","services");
