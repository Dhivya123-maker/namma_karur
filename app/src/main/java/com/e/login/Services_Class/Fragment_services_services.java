...
public class Fragment_services_services extends Fragment implements  Services_ServicesAdapter.OnItemClickListener {

    List<Services_Services_Model> servicesServicesModels;
    Services_ServicesAdapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String JSON_URL = "http://nk.inevitabletech.email/public/api/get-service-list?service_id=1";
...
//
//
//                        servicesServicesModels = new ArrayList<>();
//
//                        RecyclerView recyclerView = root.findViewById(R.id.services_services_recycle);
//
//
//                        for (int i = 0; i < response.length(); i++) {
//
//                            Services_Services_Model viewmodel = new Services_Services_Model();
//
//
...
//
//
//                            servicesServicesModels.add(viewmodel);
//
//                        }
//
//                        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
//
//                        adapter =  new Services_ServicesAdapter(getContext(),servicesServicesModels);
//                        recyclerView.setAdapter(adapter);
//                        adapter.setOnItemClickListener((Services_ServicesAdapter.OnItemClickListener) getActivity());
//
//
//
//
