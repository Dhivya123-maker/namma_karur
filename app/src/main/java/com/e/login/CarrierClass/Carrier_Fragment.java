...
public class Carrier_Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_carrier_, container, false);
...
//        String JSON_URL = "http://nk.inevitabletech.email/public/api/get-shop-product-details?product_id=1";
//
...
//
//                        RecyclerView recyclerView = root.findViewById(R.id.carrier_services_recycle);
//
//
//                        for (int i = 0; i < 1; i++) {
//
...
//
//                        adapter =  new Shop_Carrier_Adapter(getContext(),shopCarrierModelList);
