...
public class HospitalFragment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewPager = findViewById(R.id.viewpager_hos);

        // setting up the adapter
        viewPagerAdapter = new ViewPagerAdapter(getSupportFragmentManager());

        // add the fragments
        viewPagerAdapter.add(new Hospital_Fragment(), "Home");
        viewPagerAdapter.add(new Hospital_services_fragment(), "Treatments");
        ...
        tabLayout = findViewById(R.id.tab_layout_hos);
