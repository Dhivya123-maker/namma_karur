...
public class Hospital_Activity extends AppCompatActivity implements HospitalAdapter.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String JSON_URL = "http://nk.inevitabletech.email/public/api/get-hospital-category-list";
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, JSON_URL, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                Toast.makeText(Hospital_Activity.this, response.toString(), Toast.LENGTH_SHORT).show();
                ...
                try {
                    ...
                    Toast.makeText(Hospital_Activity.this, data.toString(), Toast.LENGTH_SHORT).show();
                    ...
                    if(Success.equals("true")){
                        Log.i("123",msg);
                        Toast.makeText(Hospital_Activity.this, msg, Toast.LENGTH_SHORT).show();

                        hospitalModelList = new ArrayList<>();

                        RecyclerView recyclerView =findViewById(R.id.hospitall_screen);


                        for (int i = 0; i < response.length(); i++) {

                            HospitalModel viewmodel = new HospitalModel();
                            ...
                            hospitalModelList.add(viewmodel);

                        }

                        recyclerView.setLayoutManager(new LinearLayoutManager(Hospital_Activity.this));

                        adapter =  new HospitalAdapter(Hospital_Activity.this,hospitalModelList);
                        recyclerView.setAdapter(adapter);
                        adapter.setOnItemClickListener(Hospital_Activity.this);
...
//        }
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(Hospital_Activity.this);
    ...
    public void onItemClick(int position) {
        ...
        Intent intent = new Intent(Hospital_Activity.this,Hospital_One_Activity.class);
