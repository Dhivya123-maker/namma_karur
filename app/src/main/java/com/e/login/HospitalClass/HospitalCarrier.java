...
public class HospitalCarrier extends Fragment {


    List<Hospital_Carrier_model> hospitalCarrierModelList;
    Hospital_Carrier_Adapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root =  inflater.inflate(R.layout.fragment_hospital_carrier, container, false);
        ...
        String JSON_URL = "http://nk.inevitabletech.email/public/api/get-hospital-treatment-Details?treatment_id=1";
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    if(Success.equals("true")){
                        ...
                        hospitalCarrierModelList = new ArrayList<>();

                        RecyclerView recyclerView = root.findViewById(R.id.hospital_treat_recycle);


                        for (int i = 0; i < 1; i++) {

                            Hospital_Carrier_model viewmodel = new Hospital_Carrier_model();
                            ...
                            hospitalCarrierModelList.add(viewmodel);

                        }

                        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));

                        adapter =  new Hospital_Carrier_Adapter(getContext(),hospitalCarrierModelList);
