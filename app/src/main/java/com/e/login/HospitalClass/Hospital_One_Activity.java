...
import com.e.login.TransportClass.Transport_One_Activity;
import com.e.login.TransportClass.Transport_one_Adapter;
...
public class Hospital_One_Activity extends AppCompatActivity implements Hospital_one_Adapter.OnItemClickListener {

    List<Hospital_OneModel> hospital_oneModelList;
    Hospital_one_Adapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hospital_one);


        filter = findViewById(R.id.filter_hos);
        ...
        filter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Hospital_One_Activity.this,HospitalFragment.class);
...
//        String JSON_URL = "http://nk.inevitabletech.email/public/api/get-hospital-catalog-list?hospital_category_id=1";
//
...
//                Toast.makeText(Hospital_One_Activity.this, response.toString(), Toast.LENGTH_SHORT).show();
//
//                try {
//
//
...
//                        Log.i("123",msg);
//                        Toast.makeText(Hospital_One_Activity.this, msg, Toast.LENGTH_SHORT).show();
//
//
//
//                        sliderView = findViewById(R.id.slider_hos);
...
//
//
//                        hospital_oneModelList = new ArrayList<>();
//
//                        RecyclerView recyclerView =findViewById(R.id.hos_screen_fragment);
//
//
//                        for (int i = 0; i < 3; i++) {
//
//                            Hospital_OneModel viewmodel = new Hospital_OneModel();
//
//
//                            viewmodel.setText("Services");
//                            viewmodel.setImage("1");
//                            viewmodel.setImage1("2");
//                            viewmodel.setImage3("3");
//                            viewmodel.setText_one("Address");
//                            viewmodel.setText_two("8.00 - 10.00");
//                            viewmodel.setText_three("Verified");
//                            viewmodel.setText_four("4.6");
//
//                            hospital_oneModelList.add(viewmodel);
//
//                        }
//
//                        recyclerView.setLayoutManager(new LinearLayoutManager(Hospital_One_Activity.this));
//
//                        adapter =  new Hospital_one_Adapter(Hospital_One_Activity.this,hospital_oneModelList);
//                        recyclerView.setAdapter(adapter);
//                        adapter.setOnItemClickListener(Hospital_One_Activity.this);
//
//
//
//                    }else{
...
//        };
//
//        RequestQueue requestQueue = Volley.newRequestQueue(Hospital_One_Activity.this);
