...
public class Today_News extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_today__news, container, false);

        recyclerView =root.findViewById(R.id.news_screen);



        String JSON_URL = "http://nk.inevitabletech.email/public/api/get-Today-news-list";
